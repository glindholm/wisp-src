    ...
    implements TreeWillExpandListener, TreeExpansionListener, TreeSelectionListener
{
    ...
    {
    	/*
    	 *	Set the tree to be non-editable, and to only allow one
    	 *	selection.
    	 */
     ...
     * 
     * @param	dir	The newly-selected directory.
     */
     ...
     *  expanded.&nbsp;Required as part of the <code>TreeExpansionListener</code>
     *	interface, even though we don't need it.
     * 
    ...
    /**
     *  <code>TreeWillExpandListener</code> method called before a node is
     *  collapsed.&nbsp;Required as part of the <code>TreeExpansionListener</code>
     *	interface, even though we don't need it.
     * 
     *  @param  e   <code>TreeExpansionEvent</code> describing nature of the collapse.
     */
	...
	/**
	 *	Specifies whether the sorting of directories in the list will be
	 * 	case-sensitive or case-insensitive.  Note that Windows users would
	 * 	normally expect a case-insensitive sort, while UNIX users would
	 * 	expect a case-sensitive sort.
	 * 
	 * @param	bCaseSensitive	<code>true</code> if the sort is to be 
