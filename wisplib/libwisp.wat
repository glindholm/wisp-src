...
#                       the Watcom compiler for 4gl
#			NOTE:  This form of the makefile (and make.inc)
#			uses the MSVC's nmake!!!!  The reason is that the
#			Watcom's wmake utility treats the makefiles in a
#			different fashion than what is currently set up
#			see .PRECIOUS example below.
#
...
#                       12\03\93        Updated for WISP Rel. 3.3C
#                                       (Added licwisp.obj)
#			04/08/94	CBA, rewritten for WATCOM, uses
#					MSVC's nmake utility.
...
getparm.obj: wangkeys.h wcommon.h scnfacs.h  putparm.h
...
licwisp.obj: licwisp.c wlicense.h
...
linkvect.o: linkvect.c linkvect.h idsistd.h intdef.h link.h
...
putparm.obj:  putparm.h wdefines.h wglobals.h wfiles.h
...
sharemem.obj: sharemem.c idsistd.h intdef.h werrlog.h 
