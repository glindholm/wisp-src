...
#
# Distributed with ACUCOBOL-GT version 6.0.0
# PMK: 166

CC = cc -D_LARGEFILE64_SOURCE
CFLAGS = -O2 -fomit-frame-pointer -march=i386 -mcpu=i686 $(ACUSERVER_FLAGS) $(ACUCONNECT_FLAGS) $(ACUSQL_FLAGS) $(XML_FLAGS)
LDFLAGS = -s
SHELL = /bin/sh
