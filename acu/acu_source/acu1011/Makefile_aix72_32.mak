...
#
# Distributed with ACUCOBOL-GT version 10.1.1
# PMK: 41

VERSPATHNAME = 1011
ACUVERSPATH = /opt/acucorp/1011
ACUPATH = /opt/acu
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = cc_r -q32 -qlanglvl=extc89 -qkeyword=inline -qcpluscmt -qarch=pwr4 -qmaxmem=16384 -bmaxdata:0x80000000 -D_LARGE_FILES
EXTRA_CFLAGS =
CFLAGS = -O2 \
