...
/*
** Copyright (C) 1993,1995,1997-1999,2001,2004,2007,2010 Micro Focus.
** All rights reserved.
*/
...
const char what_lib_direct_c_str[] = "@(#) " ACU_SOURCE_FILENAME " $Date: 2015-02-03 23:08:02 +0000 (Tue, 03 Feb 2015) $$Rev: 66996 $";
