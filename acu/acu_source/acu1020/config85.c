...
const char what_lib_config85_c_str[] = "@(#) " ACU_SOURCE_FILENAME " $Date: 2017-12-22 17:24:40 +0000 (Fri, 22 Dec 2017) $$Rev: 72641 $";
...
int AdumpRuntimeState(char *, FILE *);
...
int
AdumpRuntimeState(char *reasonText A_UNUSED, FILE *dumpFile A_UNUSED)
{
    return 0;
} /* AdumpRuntimeState */
