 ...
 *
 *	Version = @(#) $Revision: 72641 $ $Date: 2017-12-22 17:24:40 +0000 (Fri, 22 Dec 2017) $
 *
 *RMFILT%IF ! RELEASE_BUILD
 *
 *  $Id: rtcallbk.h 72641 2017-12-22 17:24:40Z mark $
 *  $URL: https://nwb-svn/acu/tags/v10-2-1-release-nov-08-rc-0/cobolgt/lib/rtcallbk.h $
 *  $Date: 2017-12-22 17:24:40 +0000 (Fri, 22 Dec 2017) $
 *
...
/* Copyright (C) 2008-2011,2015 Micro Focus.  All rights reserved. */
...
{                                                                                                       /* IF BIS IS LOADED: */
    ...
    int (*biste_read_request_string)(const void **ppRequestString, int *pnRequestLen, int nSecs, int nReserved);	   /* -> BIS_ReadRequestString_C_Callback */      /* ACU10 */
    int (*biste_write_response_string)(const void *pResponseString, int nResponseLen, int nResponseType, int nReserved);   /* -> BIS_WriteResponseString_C_Callback */    /* ACU10 */
#if 0
