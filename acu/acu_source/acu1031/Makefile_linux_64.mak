...
#
# Copyright (C) 1995-2010,2014,2019 Micro Focus.  All rights reserved.
#
# To relink the runtime, run: make runcbl
# To relink the ESQL pre-compiler, run: make acusql
#
# Distributed with ACUCOBOL-GT version 10.3.1
# PMK: 59

VERSPATHNAME = 1031
ACUVERSPATH = /opt/acucorp/1031
ACUPATH = /opt/acu
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = cc -std=gnu99 -m64 -pthread -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=500 -D_BSD_SOURCE
EXTRA_CFLAGS =
...
AFSI2_LIB = $(ACU_LIBDIR)/libfsi2.a
PDF_LIB = $(ACU_LIBDIR)/libapdf.a
...
clean:
	-rm -f runcbl acusql callc.o filetbl.o sub.o
