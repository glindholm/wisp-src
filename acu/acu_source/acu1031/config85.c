/*
** Copyright (C) 1993-2008,2010,2015-2017 Micro Focus.
** All rights reserved.
*/
...
const char what_lib_config85_c_str[] = "@(#) " ACU_SOURCE_FILENAME " $Date: 2018-10-23 19:30:31 +0100 (Tue, 23 Oct 2018) $$Rev: 74373 $";
...
void AAnalyzeParagraph(int);
int AconditionTrue(void);
void AcountParaEntry(void);
void AcreateDebugToolbar(void);
char *Adbgalloc(void);
int AdbgComposeOpValueString(char *, void *, int);
void AdbgEnableTool(int, int);
void AdbgEnableToolbar(int);
int AdbgLoadOp(void *, void *, char *, int *);
void AdbgUseDebugScript(char *);
void Ado_help(void);
int AdumpRuntimeState(char *, unsigned);
void Adump_all_symbols(char *);
void Adump_sym_table(unsigned, void *);
...
int Aload_symbol_info(void);
char *Apgh_name(short, unsigned, char *, size_t, int);
...
void
AAnalyzeParagraph(int eEnterLeave A_UNUSED)
{
    return;
} /* AAnalyzeParagraph */
...
int
AdbgComposeOpValueString(char *buf A_UNUSED, void *op A_UNUSED,
	int maxsize A_UNUSED)
{
    return 0;
} /* AdbgComposeOpValueString */
...
int
AdbgLoadOp(void *op A_UNUSED, void *dptr A_UNUSED, char *msg A_UNUSED,
	int *piErr A_UNUSED)
{
    return 0;
} /* AdbgLoadOp */
...
void
AdbgUseDebugScript(char *var A_UNUSED)
{
    return;
} /* AdbgUseDebugScript */
...
int
AdumpRuntimeState(char *reasonText A_UNUSED, unsigned dumpFile A_UNUSED)
{
    return 0;
} /* AdumpRuntimeState */

void
Adump_all_symbols(char *var A_UNUSED)
{
    return;
} /* Adump_all_symbols */

void
Adump_sym_table(unsigned var1 A_UNUSED, void *var2 A_UNUSED)
{
    return;
} /* Adump_sym_table */
...
int
Aload_symbol_info(void)
{
    return 0;
} /* Aload_symbol_info */

char *
Apgh_name(short ovly A_UNUSED, unsigned addr A_UNUSED, char *str A_UNUSED,
	size_t maxlen A_UNUSED, int formatFlag A_UNUSED)
{
    return NULL;
} /* Apgh_name */
...
int
Asig_break(int sig A_UNUSED)
{
    return 0;
} /* Asig_break */

int
Asig_quit(int sig A_UNUSED)
{
    return 0;
} /* Asig_quit */
...
void
dbgipc_eprintf(char *s A_UNUSED)
{
    return;
} /* dbgipc_eprintf */
