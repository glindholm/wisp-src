...
/*
** Copyright (C) 1993-1995,1997-2011,2015-2016,2019 Micro Focus.
** All rights reserved.
*/
...
{
    const char	*EntryPointCobolName;	        /* name of subroutine as in call  */
    int 	(* const EntryPointAddress)();  /* entry point address */
    const char	*EntryPointName;	        /* name of entry point in the object */
...
/*  And they are multi-thread safe, if you are using a multi-thread safe  */
...
#ifndef ACURETURNCODE_T
#ifdef	_WIN64
#define	ACURETURNCODE_T	INT_PTR
#else	/* _WIN64 */
#define	ACURETURNCODE_T	long
#endif	/* _WIN64 */
#endif /* ACU_RETURNCODE_T */

#ifndef	return_code
extern	ACURETURNCODE_T	*Astdlib_return_code(void);
