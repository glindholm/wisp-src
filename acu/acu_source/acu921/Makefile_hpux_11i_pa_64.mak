...
#
# Distributed with ACUCOBOL-GT version 9.2.1
# PMK: 167

VERSPATHNAME = 921
ACUVERSPATH = /opt/acucorp/921
ACUPATH = /opt/acu
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = cc -Ae +DS2.0 +DA2.0W +DD64 -Wl,+s -D_REENTRANT -D_LARGEFILE64_SOURCE -DO_LARGEFILE=0 +z -DCOBOL_64BIT
EXTRA_CFLAGS =
CFLAGS = +O2 \
