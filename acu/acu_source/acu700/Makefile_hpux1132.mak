...
#
# Distributed with ACUCOBOL-GT version 7.0.0
# PMK: 235

VERSPATHNAME = 700
ACUVERSPATH = /opt/acucorp/700
ACUPATH = /opt/acu
JAVA_FLAG =
CC = cc -Ae +DAportable -Wl,+s -D_LARGEFILE64_SOURCE
CFLAGS = +O2 \
	$(ACUSERVER_FLAGS) $(ACUCONNECT_FLAGS) $(ACUSQL_FLAGS) $(EXTSM_FLAGS) \
	$(JAVA_FLAG) $(XML_FLAGS) $(EXTFH_FLAGS)
EXTRA_LDFLAG = -Wl,+b -Wl,$(ACUVERSPATH)/lib:$(ACUPATH)/lib:.:../stdlib:/usr/lib:/lib
EXEC_LDFLAG =
EXPORT_LDFLAG =
