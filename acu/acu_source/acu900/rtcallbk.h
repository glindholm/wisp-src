...
#define ARGUMENT_ENTRY	struct ARGUMENT_ENTRY
...
/*RMFILT%ENDIF #*/
    ...
    int     (*pAssertDigits)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     unsigned short MaxValue,
					     unsigned short MinValue);
    int     (*pAssertDigitsLeft)	    (short ArgCount,short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     unsigned short MaxValue, unsigned short MinValue);
    int     (*pAssertDigitsRight)	    (short ArgCount, short ArgNumber,ARGUMENT_ENTRY Arguments[], int Flags,
					     unsigned short MaxValue, unsigned short MinValue);
    int     (*pAssertLength)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     unsigned long MaxValue, unsigned long MinValue);
    int     (*pAssertSigned)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags);
    int     (*pAssertUnsigned)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags);
    ...
    int     (*pCobolDescriptorAddress)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter);
    int     (*pCobolDescriptorDigits)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pCobolDescriptorLength)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pCobolDescriptorScale)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pCobolDescriptorType)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pCobolInitialState)	    (int Flags, void *Parameter, int Size, short State);
    int     (*pCobolToFloat)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags, int Occurs,
					     double Omitted, void **Parameter, int Repeat, int Size);
    int     (*pCobolToGeneralString)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[],
					     CONV_TABLE *ConvTable, int Flags,
					     int Occurs, char *Omitted, void **Parameter, int Repeat, int Size,
					     short Value1, short Value2);
    int     (*pCobolToInteger)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     int Occurs, long Omitted, void **Parameter, int Repeat, short Scale, int Size);
    int     (*pCobolToNumericString)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[],
					     CONV_TABLE *ConvTable, int Flags,
					     int Occurs, char *Omitted, void **Parameter, int Repeat, int Size);
    int     (*pCobolToPointerAddress)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter);
    int     (*pCobolToPointerBase)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter);
    int     (*pCobolToPointerLength)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pCobolToPointerOffset)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter, int Size);
    int     (*pCobolToPointerSize)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter, int Size);
    int     (*pCobolToString)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[],
    ...
    int     (*pFloatToCobol)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     int Occurs, void *Parameter, int Repeat, int Size);
    int     (*pGeneralStringToCobol)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     int Occurs, void *Parameter, int Repeat, int Size, short value1, short Value2);
    int     (*pIntegerToCobol)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     int Occurs, void *Parameter, int Repeat, short Scale, int Size);
    int     (*pNumericStringToCobol)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     int Occurs, void *Parameter, int Repeat, int Size);
    int     (*pPointerBaseToCobol)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter);
    int     (*pPointerOffsetToCobol)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pPointerSizeToCobol)	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void *Parameter, int Size);
    int     (*pStringToCobol)		    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     int Occurs, void *Parameter, int Repeat, int Size, short Value1, short Value2);
    CALLER_INFO * (*pGetCallerInfo)	    (void);
    char *  (*pGetEsectBase)		    ();
    char *  (*pGetEsectLimit)		    ();
    int     (*pLoadCobolInt)		    (ARGUMENT_ENTRY *pArgEntry);
    void    (*pStoreCobolInt)		    (ARGUMENT_ENTRY *pArgEntry, int Value);
...
/* table_version >= 0x1200 */
    ...
    unsigned int(*pLoadCobolUInt)           (ARGUMENT_ENTRY *pArgEntry);
    void    (*pStoreCobolUInt)		    (ARGUMENT_ENTRY *pArgEntry, unsigned int Value);
...
/* table version >= 0x1300 */		/* extend 9.0 */
    ...
    int     (*pACobolToPointer) 	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter);
    int     (*pPointerToACobol) 	    (short ArgCount, short ArgNumber, ARGUMENT_ENTRY Arguments[], int Flags,
					     void **Parameter);
