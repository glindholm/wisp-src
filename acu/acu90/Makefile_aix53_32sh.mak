...
#       ${ACUDIR}  - Acucobol-GT 9.0.x directory (e.g. /opt/acu)
...
#	   ${WISPDIR}/acu/sub85_acu90.c
#	   ${WISPDIR}/acu/acu90/Makefile_aix53_32sh.mak
#
#	2) Replace the file sub85.c with sub85_acu90.c
#
#	   $ mv sub85.c sub85.c.original
#	   $ cp sub85_acu90.c sub85.c
#
