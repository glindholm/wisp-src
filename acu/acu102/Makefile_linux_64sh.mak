...
#	   ${WISPDIR}/acu/acu102/Makefile_linux_64sh.mak
#
#	2) Build the new libruncbl64.so shared runtime file
#
#	   $ make -f Makefile_linux_64sh.mak clean libruncbl64.so
#	
...
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = cc -std=gnu99 -m64 -pthread -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_XOPEN_SOURCE=500 -D_BSD_SOURCE -fpic
