#############################################################################
#	File:	Makefile_aix71_32sh.mak
#
#	Acucobol:  10.2.0 
#	Platform:  AIX 7.1 32-bit (Shared)
#	WISP:      5.1.20
#
...
#	   ${WISPDIR}/acu/acu102/Makefile_aix71_32sh.mak
#
#	2) Build the new libruncbl.so shared runtime file
#
#	   $ make -f Makefile_aix71_32sh.mak clean libruncbl.so
#	
...
#
# Distributed with ACUCOBOL-GT version 10.2.0
# PMK: 53
...
VERSPATHNAME = 1020
ACUVERSPATH = /opt/acucorp/1020
ACUPATH = /opt/acu
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = xlc_r  -q32 -qarch=com -qmaxmem=16384 -bmaxdata:0x80000000 -D_LARGE_FILES 
