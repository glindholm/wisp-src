#############################################################################
#	File:	Makefile_aix53_32sh.mak
#
#	Acucobol:  9.1.0 
#	Platform:  AIX 5.3 32-bit (Shared)
#	WISP:      5.1.00
#
...
#       ${ACUDIR}  - Acucobol-GT 9.1.x directory (e.g. /opt/acu)
...
#	   ${WISPDIR}/acu/sub85_acu91.c
#	   ${WISPDIR}/acu/acu91/Makefile_aix53_32sh.mak
#
#	2) Replace the file sub85.c with sub85_acu91.c
#
#	   $ mv sub85.c sub85.c.original
#	   $ cp sub85_acu91.c sub85.c
#
#	3) Build the new libruncbl.so shared runtime file
#
#	   $ make -f Makefile_aix53_32sh.mak clean libruncbl.so
#	
...
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = cc -q32 -qlanglvl=extc89 -qcpluscmt -qarch=com -qmaxmem=16384 -bmaxdata:0x80000000 -D_THREAD_SAFE 
