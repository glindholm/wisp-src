...
/*
** Copyright (C) 1993,1995,1997,1999-2003,2007-2008,2010 Micro Focus.
** All rights reserved.
*/
...
const char what_lib_sub85_c_str[] = "@(#) " ACU_SOURCE_FILENAME " $Date: 2016-09-01 23:40:55 +0100 (Thu, 01 Sep 2016) $$Rev: 70268 $";
