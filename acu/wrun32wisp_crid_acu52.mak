...
#################################################################
#
# Creating an Acucobol 5.2 runtime requires WISP 4.4.02 and 
# CRID 3.0.04 or later.
#
...
#       Copy $(CRIDDIR)\wrun32wisp_crid_acu52.mak 
#            $(CRIDDIR)\crid.h
#            $(CRIDDIR)\cridtbl.c
#            $(CRIDDIR)\crid85.c
#            $(WISPDIR)\acu\sub85.c
...
#       $ NMAKE /f wrun32wisp_crid_acu52.mak
#
...
#       to   $(ACUDIR)\acugt\bin\wrun32wispc.alc
#
#################################################################
#
