#############################################################################
#	File:	Makefile_hpux1123sh_32.mak
#
#	Acucobol:  8.1.2 
#	Platform:  HP-UX 11.23i IA 32-bit
#	WISP:      5.1.00
#
...
#	   ${WISPDIR}/acu/acu81/Makefile_hpux1123sh_32.mak
#
...
#
#	3) Build the new libruncbl.sl shared runtime file
#
#	   $ make -f Makefile_hpux1123sh_32.mak clean libruncbl.sl
#	
#	4) Setup your configuration to use the new runtime.
#
#	   Add $ACUDIR/lib to the SHLIB_PATH per the Acucobol setup
#	   instructions.
#
#	   $ export SHLIB_PATH=$ACUDIR/lib:$SHLIB_PATH
#
...
#
# Distributed with ACUCOBOL-GT version 8.1.2
# PMK: 120
...
VERSPATHNAME = 812
ACUVERSPATH = /opt/acucorp/812
ACUPATH = /opt/acu
ACUSQL_MAIN_MODULE = 
JAVA_FLAG =
CC = cc -Ae +DAportable -Wl,+s -D_REENTRANT -D_LARGEFILE64_SOURCE +z
CFLAGS = +O2 \
...
AXML_LIB = $(ACU_LIBDIR)/libaxml.$(SHARED_LIB_EXT)
