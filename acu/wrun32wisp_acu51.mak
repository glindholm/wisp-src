...
#################################################################
#
# Creating an Acucobol 5.1 runtime requires WISP 4.4.00 or later
# Creating an Acucobol 4.3 runtime requires WISP 4.3.06 or later
#
...
#       Copy $(WISPDIR)\acu\wrun32wisp_acu51.mak 
#            $(WISPDIR)\acu\sub85.c
