...
$(WISPKIT)\ETC\RELNOTES.TXT:	$(BASEDIR)\ETC\RELNOTES
	$(COPY) $** $@
...
$(CREATEACUKIT)\CREATE.EXE:	$(BASEDIR)\CREATEACU\$(@F)
	$(COPY) $** $@
...
$(RTSKIT)\WWRUNCBLK.EXE:	$(BASEDIR)\CRIDACU\$(@F)
	$(COPY) $** $@

$(RTSKIT)\WWRUNCBLKE.EXE:	$(BASEDIR)\CRIDACU\$(@F)
	$(COPY) $** $@
