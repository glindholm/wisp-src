...
*********************************************************************************************************************************/
int ring_open( id, esize, alloc1, alloc2, ecompare, sorted_flag )
...
*********************************************************************************************************************************/
int ring_add(ring_ptr,position,element)
ring_struct	*ring_ptr;
int	position;
char	*element;
{
...
*********************************************************************************************************************************/
static list_struct *pointpos(list_head,position)
...
*********************************************************************************************************************************/
int ring_replace(ring_ptr,position,element)
ring_struct	*ring_ptr;
int	position;
char	*element;
{
...
*********************************************************************************************************************************/
int ring_remove(ring_ptr,position,element)
ring_struct	*ring_ptr;
int	position;
char	*element;
{
...
*********************************************************************************************************************************/
int ring_get(ring_ptr,position,element)
ring_struct	*ring_ptr;
int	position;
char	*element;
{
...
*********************************************************************************************************************************/
int ring_find(ring_ptr,match,position,element)
ring_struct	*ring_ptr;
char	*match;
int	*position;
char	*element;
...
*********************************************************************************************************************************/
int ring_push(ring_ptr,element)
ring_struct	*ring_ptr;
char		*element;
{
...
int ring_unque(ring_ptr,element)
ring_struct	*ring_ptr;
char		*element;
{
	return( ring_remove(ring_ptr,0,element) );
...
int ring_front(ring_ptr,element)
ring_struct	*ring_ptr;
char		*element;
{
	return( ring_get(ring_ptr,0,element) );
...
int ring_back(ring_ptr,element)
ring_struct	*ring_ptr;
char		*element;
{
...
*********************************************************************************************************************************/
static int real_get(ring_ptr,position,element,list_rtn_ptr)
ring_struct	*ring_ptr;
int	position;
char	*element;
list_struct **list_rtn_ptr;
{
	int	rc;
	list_struct *list_ptr;
	int	realpos;
...
*********************************************************************************************************************************/
static unload_element(element,list_ptr,size)
char	*element;
list_struct *list_ptr;
{
...
*********************************************************************************************************************************/
static int free_element(ring_ptr,list_ptr)
ring_struct	*ring_ptr;
list_struct	*list_ptr;
{
...
*********************************************************************************************************************************/
static int validatepos(cnt,position)						/* Check if position is in ring.		*/
int	cnt;
int	position;
{
...
*********************************************************************************************************************************/
static int quitpath(cnt,position)
int	cnt;
int	position;
{
	int	pospos;
...
*********************************************************************************************************************************/
static int realadd(list_head, list_new, position)
list_struct	*list_head;
list_struct	*list_new;
int		position;
{
...
*********************************************************************************************************************************/
static int findpos(ring_ptr,match,position,list_rtn_ptr)
ring_struct	*ring_ptr;
char	*match;
int	*position;
list_struct **list_rtn_ptr;
...
*********************************************************************************************************************************/
static int new_block( ring_ptr, num)
ring_struct *ring_ptr;
int	num;								/* Number of elements in block				*/
{
...
*********************************************************************************************************************************/
static int list_corrupt(list_ptr)
list_struct	*list_ptr;
{
