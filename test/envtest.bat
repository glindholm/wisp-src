...
set WISPSHAREDIR=C:\temp\wispsharedir
set WPROC=%WISPDIR%\bin\wproc.exe
set WPROCDEBUG=
set WISPEDITOR=notepad.exe
set WISPCPU=1234
set WISPNETID=87654321
set WISP_SCRATCH_MODE=32
set WISP_DISPLAY_8BIT=NO
